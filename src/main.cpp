...
const string strMessageMagic = "runcoin Signed Message:\n";
...
static const int64 nTargetTimespan = 60 * 60; // runcoin: 1 hour
static const int64 nTargetSpacing = 120; // runcoin: 2 minute blocks
                                 ...
                                 const CBlockIndex* pindexBlock, bool fBlock, bool fMiner, bool fStrictPayToScriptHash)
{
    ...
    // fMiner is true when called from the internal runcoin miner
...
bool CheckDiskSpace(uint64 nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "runcoin", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0x12fd4e5bd177f8310cc946fccb0211980dfb7097d0f0937d65f4107ce6f72018");
    }
    ...
    if (mapBlockIndex.empty())
    {
        ...
        // Genesis block
        const char* pszTimestamp = "Deputy charged in Tulsa Shooting";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nVersion = 1;
        block.nTime    = 1428972536; //epochtime
        block.nBits    = 0x1e0ffff0;
        block.nNonce   = 0;

        if (fTestNet)
        {
            block.nTime    = 1428972536;
            block.nNonce   = 611644;
        }
        ...
        assert(block.hashMerkleRoot == uint256("0xf4cc31664cd8cbb116017e9c86d6146e6347e71ce6d32ab65fe4242145f6b459"));
